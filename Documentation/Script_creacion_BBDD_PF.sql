...
CREATE TABLE caballos(
    ...
    raza_caballo VARCHAR(50),
    nacionalidad_caballo VARCHAR(50)
);
...
CREATE TABLE concursos(
    ...
    categoría_concurso VARCHAR(50),
    pais_concurso VARCHAR(50),
    provincia_concurso VARCHAR(50),
    localidad_concurso VARCHAR(50),
    ámbito_concurso VARCHAR(50),
    federacion_concurso VARCHAR(50),
...
CREATE TABLE resultados(
    ...
    id_caballo VARCHAR(50) REFERENCES caballo(id_caballo)
