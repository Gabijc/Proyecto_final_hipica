...
import os
from src.soporte_carga_dashboard import conexion_BBDD, ejecutor_querys, concursos_seleccionado, info_jinete_caballo, graficos_provincias   # type: ignore
    ...
    # Vista "Concursos"
        ...
        if seleccion_concurso:
            ...
            if st.session_state.vista_concurso == "lista_pruebas":
                ...
                resultados_df = pd.DataFrame(ejecutor_querys(cur, query_resultados)).rename(columns = {0: "Estado", 1: "Puesto", 2:"Jinete", 3: "Caballo", 4: "Puntos Obs R1", 5: "Puntos Temp R1", 6: "Tiempo R1",
                                                                                                  7: "Puntos Obs R2", 8: "Puntos Temp R2", 9: "Tiempo R2", 10: "Puntos Obs R3", 11: "Puntos Temp R3", 12: "Tiempo R3"}).drop_duplicates()
